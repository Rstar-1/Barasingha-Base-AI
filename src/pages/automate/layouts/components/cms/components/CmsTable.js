...
import {
  paginationcmstextdata,
  deletecmstextdata,
  updatecmstextdata,
} from "../../../../../../redux/cmsredux/TextSlice";
...
const CmsTable = () => {
  ...
  const handleDelete = async (id) => {
    try {
      const resultAction = await dispatch(deletecmstextdata(id));
      if (deletecmstextdata.fulfilled.match(resultAction)) {
