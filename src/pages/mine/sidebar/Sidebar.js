...
const Sidebar = () => {
  return (
    <div className="bgforth h-100 overflow-auto relative sidebar">
      <div className="">
                    ...
                    <>
                      <div class="accordion my2">
                        <div class="tab">
                          ...
                          <label
                            for={e.tabId}
                            className="py10 px12 cursor-pointer flex justify-between items-center font-300"
                          >
                            <div className="flex items-center gap-4">
                              <FeatherIcon
                                ...
                                size={16}
                              />
                              <p className="fsize13 textwhite mtpx2 font-300 plpx4">
                                {e.name}
                              </p>
                            </div>
                            <div className="flex items-center gap-4">
                          ...
                          <div class="tab__content">
                            <div className="grid grid-cols-1 prpx15 plpx10 bg-glass2 py10 rounded-5">
                              {e.dropdown.map((drop) => (
                                <NavLink
